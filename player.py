...
class Player(pygame.sprite.Sprite):
    ...
    def import_assets(self):       
        self.animations = {}
        for index, folder in enumerate(walk('progress/project_3 - player_movement/graphics/player')):
            if index == 0:
    ...
    def move(self,dt):
        ...
        self.hitbox.centerx = round(self.pos.x) # moving hitbox
        self.rect.centerx = self.hitbox.centerx # drawing
